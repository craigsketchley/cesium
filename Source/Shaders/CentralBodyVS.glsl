...
{
    return calcPush1d(loc.x, u_pushExtent.x, u_pushExtent.x + u_pushBlend, u_pushExtent.z - u_pushBlend, u_pushExtent.z)
    * calcPush1d(loc.y, u_pushExtent.y, u_pushExtent.y + u_pushBlend, u_pushExtent.w - u_pushBlend, u_pushExtent.w);
}
#endif
